...
private func getQueue<T>(initialValue: T) -> LockFreeLinkQueue<T>
{
  return LockFreeLinkQueue(initialValue)
}

func LockFreeLinkQueueRunTest(workers: Int, run: Int = 0) -> Int
{
