...
const void* LoadVoidPtr(void** ptr)
{
  return __c11_atomic_load((_Atomic(void*)*)ptr, __ATOMIC_RELAXED);
}

const void* SyncLoadVoidPtr(void** ptr)
{
...
long long SyncLoad64(long long *ptr)
{
